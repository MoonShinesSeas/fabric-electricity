...
export const constantRoutes = [
...

  {
    ...
    redirect: '/elec/table',
    name: 'Example',
    meta: { title: '电力信息管理', icon: 'example' },
    children: [
      {
        path: 'list',
        name: 'Table',
        component: () => import('@/views/elec/list'),
        meta: { title: '电力信息', icon: 'table' }
      },
      {
        path: 'search',
        name: 'Tree',
        component: () => import('@/views/elec/search'),
        meta: { title: '电力市场', icon: 'tree' }
      }
    ]
  },
